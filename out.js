...
module("src/transform", function(module) {
    var exports = module.exports;
    var util, Cache, Scope, UnresolvedSymbol, Transform;
    util = __require('src/util');
    ...
    module.exports.UnresolvedSymbol = UnresolvedSymbol;
